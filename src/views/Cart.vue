...
export default {
  ...
  setup() {
    ...
    store.commit('SELECT_PAGE', 'Корзина')
    const addedPizzas = computed(() => store.getters.getCartItemsPizzas)
    ...
    return { clearCart, totalCount, totalSum, addedPizzas }
  },
}
</script>
